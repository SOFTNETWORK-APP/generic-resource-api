...
object ResourceMessages {
  ...
  case class CreateResource(uuid: String, bytes: Array[Byte], uri: Option[String])
      extends ResourceCommand

  case class UpdateResource(uuid: String, bytes: Array[Byte], uri: Option[String])
      extends ResourceCommand
  ...
  class ResourceError(override val message: String)
